...
@app.route("/target_visualization")
...
def get_input():
    ...
    if not search_input:
        return render_template("target_visualization.html", error="Please provide a valid search input.")
    try:
        radius = float(radius)
    except ValueError:
        return render_template("target_visualization.html", error="Please provide a valid radius value like 0.5, 1 etc...")

    if radius <= 0:
        return render_template("target_visualization.html", error="Please provide a positive radius value.")
    ...
    if sector_selection:
        ...
        try:
            ...
            return render_template("target_visualization.html", error="Please provide a valid sector number.")
    else:
    ...
    try:
        ...
        return render_template("target_visualization.html", results=results, star_name=object_name, sector_num=sector_number, diagram1=html1, diagram2=html2, diagram3=html3, diagram4=html4, csv_results=csv_results, download_url=download_url, enumerate=enumerate, table_visibility=table_visibility)
